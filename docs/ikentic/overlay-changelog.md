...
### pr/docker-compose-healthcheck
- Functionality: Adds gateway healthcheck to the default docker-compose service.
- Bead: `ikeagent-9883` (PR pending: pr/docker-compose-healthcheck).
- Upstream PR: Not submitted (pending).
...
- Bead: `ikeagent-9884` (PR pending: overlay/consolidated-internal-commits).
- Upstream PR: Not submitted (pending).
