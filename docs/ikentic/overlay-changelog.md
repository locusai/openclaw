...
- Functionality: Adds Ikentic docker-compose base + mount overlays (`mount-state`, `mount-plugin`, `mount-all`) for running the IKENTIC plugin in NPM or local-dev modes.
